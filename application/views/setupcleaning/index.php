...
$(document).ready(function() {	 
	...
	getAjaxProject() ;
	 function getAjaxProject() {
					$.ajax({    //create an ajax request to display.php
							type: "GET",
							url: <?php echo  "'".  URL  ."SetupCleaning/FacilityList'";?>,             
	...
	$("#addmaker").submit(function(){
					...
					$.ajax({
							type: "POST",
								url: <?php echo  "'".  URL  ."SetupCleaning/AddFacilities'";?>,         
							data: $(this).serialize()
							})
							.done(function(data){
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
			...
			<span class="laotext">ຕັ້ງຄ່າທຳຄວາມສະອາດ </span></h1>
          </div><!-- /.col -->
          <!--  <div class="col-sm-6">
        ...
        <div class="modal-dialog ">
          <div class="modal-content">
            <div class="modal-header">
			  ...
			  <span class="laotext">ເພີ່ມສະຖານທີ່ໃໝ່</span></h4>
