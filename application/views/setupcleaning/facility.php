    ...
    <span aria-hidden="true">&times;</span>
                ...
                <table class="table table-bordered table-hover  table-striped table-responsive" id="example" width="100%" height="500px" cellspacing="0">
                 <thead>
				  ...
				  if (isset($app->dutiesCount)){ $dutiesCount= $app->dutiesCount;}	else{ $dutiesCount=0;}
...
$(document).ready(function(){
	 $('.closemodal').click(function(){		 	
	   ...
	   $('.ViewModel').click(function(){
			...
			$.ajax({
					url: <?php echo "'". URL . "'" ?> + "SetupCleaning/VehicleModel?id=" + id,
					type: 'GET',
					data: { id:id },
					success: function(response){
					//alert(response);
		...
		$("#AddModel").submit(function(){
				$("#responseAdd").hide();
					$.ajax({
							type: "POST",
								url: <?php echo  "'".  URL  ."SetupCleaning/AddDuties'";?>,         
							data: $(this).serialize()
							})
							.done(function(data){
    ...
    $('.deleteGroup').click(function(){
	  ...
	  if (r == true) {
        ...
        var deleteid = splitid[1];
				...
				$.ajax({
					url: <?php echo "'". URL . "'" ?> + "SetupCleaning/DeleteteMaker",
					type: 'GET',
					data: { id:deleteid },
					success: function(response){
					//alert(deleteid);
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
			  ...
			  <span class="laotext">ເພີ່ມໜ້າວຽກ</span></h4>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
			  ...
			  <span class="laotext">ເບິ່ງໜ້າວຽກ</span></h4>
              <button type="button" class="close closemodal" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
