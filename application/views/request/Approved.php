				   ...
				   $returnTimekey='';
					...
					<div class='card'>
						...
						<div class='card-body' style='font-size:12px'>
							...
							<hr>
							<a href='#' class='btn btn-primary btn-xs viewDetails'  style='width:100%'
							...
							";
								if($lineManager=='P'){
									echo '
									<button   class="btn btn-xs  bg-gradient-danger btn-flat appManagerCancel" id="del_'.$rid.'" style="width:50%">
																<i class="fas fa-trash"></i> Cancel
								    </button>
									<button   class="btn btn-xs  bg-gradient-success btn-flat appManager" id="del_'.$rid.'" style="width:50%">
...
$(document).ready(function(){
	 $('.closemodal').click(function(){		 	
	  ...
	  $('.closemd').click(function(){	  
	    ...
	    $(".appManagerCancel").click(function(){
			...
			//alert(id);
			 ...
			 $.ajax({
					url:  <?php echo "'". URL ."'"?> + "Request/CancelledRequest?id=" + id,
					type: "GET",
					data: { id:id },
	    ...
	    $(".appManager").click(function(){
			...
			//alert(id);
			 ...
			 $.ajax({
					url:  <?php echo "'". URL ."'"?> + "Request/UpdateStatus?type=linemanager&&id='" + id,
					type: "GET",
					data: { id:id },
					success: function(response){
						//alert(response);
