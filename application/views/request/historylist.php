				  ...
				  if (isset($app->Dfname))  {$Dfname= $app->Dfname;}else{$Dfname='';}		
					...
					<div class='card'>
						...
						<div class='card-body' style='font-size:12px'>
							...
							<b>DEPART /<span class='laotext'>ອອກໄປ</span></b> : <br>".strtoupper($departdate)."  ".$daparttime." <br>
							...
							<hr>
							<a href='#' class='btn btn-primary btn-sm viewDetails'  style='width:100%'
...
$(document).ready(function(){
  ...
  <!--<button type="sumbit" id ="takecar" class="btn btn-primary" >Take Car
  </button>-->
