  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Take car/
			<span class="laotext">ເອົາລົດ</span></h1>
          </div><!-- /.col -->
           <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo URL ;?>Inspection" >Car List/
			  <span class="laotext">ລາຍການລົດທີ່ຈອງ</span></a></li>
              <li class="breadcrumb-item active">Update Vehicle Takecar/
			  <span class="laotext">ປັບປຸງການເອົາລົດ</span></li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
					Update Vehicle Takecar/
					<span class="laotext">ປັບປຸງການເອົາລົດ</span>
				</h3>
              </div>
              <!-- /.card-header -->
					<div class="card-body">
