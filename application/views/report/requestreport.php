	...
	getAjaxProject() ;
	 function getAjaxProject() {
					$.ajax({    //create an ajax request to display.php
							type: "GET",
							url: <?php echo  "'".  URL  ."Report/RequestVehicleReportPro'";?>,             
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
			...
			<span class="laotext">ລາຍງານພະຫະນະ </span></h1>
          </div>
				...
				<div class="row">
						...
						Maker/<span class="laotext">ຍີ່ຫໍ້
							<div class="input-group mb-3">
							 ...
							 <span class="laotext">ເລືອກຍີ່ຫໍ້</span></option>
							 <?php
						...
						<div class="col-md-4">						
							...
							<span class="laotext">ເລືອກລຸ້ນ</span></div>
						</div>
			   </div>
				...
				<div class="row">
						<div class="col-md-4">
							...
							<select  class="form-control" name="fuel" required>	
									...
									<span class="laotext">ພິເສດ</span></option>
							  </select>					
							</div>
						</div>
						<div class="col-md-4">						
